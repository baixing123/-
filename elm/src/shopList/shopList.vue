<template>
  <div id="box1">
    ...
    <el-table :data="table" style="width: 100%">
      <el-table-column label="店铺名称" width="170" property="name">


      </el-table-column>
      <el-table-column label="店铺地址" width="280" property="address">


      </el-table-column>
      <el-table-column label="店铺介绍" width="260" property="category">
...
<script>
  ...
  import Hrader from '../hrader/hrader.vue'
  export default {
    data() {
      return {
        table: [],
    ...
    created() {
      ...
      this.shop = this.$route.params.shopname;
    },
    methods: {
